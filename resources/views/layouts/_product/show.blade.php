...
<!-- end breadcrumbs -->
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <ul>
          <li class="home"> <a href="#" title="Go to Home Page">Home</a><span>&mdash;›</span></li>
          <li class=""> <a href="grid.html" title="Go to Home Page">Product</a><span>&mdash;›</span></li>
          <li class="category13"><strong> Telur Bebek </strong></li>
        </ul>
      </div>
    </div>
  </div>
              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-lg-6 col-sm-6 col-xs-12">
                  <ul class="moreview" id="moreview">
                    ...
                    <li class="moreview_thumb thumb_2 moreview_thumb_active"> <img class="moreview_thumb_image" src="{{ asset('frontend/products-images/telurbebek.jpg') }}" alt="thumbnail"> <img class="moreview_source_image" src="{{ asset('frontend/products-images/telurbebek.jpg') }}" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="{{ asset('frontend/products-images/telurbebek.jpg') }}"></li>
                ...
                <div class="product-shop col-lg-6 col-sm-6 col-xs-12">
                  ...
                  <div class="price-block">
                    <div class="price-box">
                      <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> Rp.45.000 </span> </p>
                      <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> Rp.38.000</span> </p>
                    </div>
                  </div>
                                ...
                                <div class="info-inner">
                                  ...
                                  <div class="item-content">
                                    ...
                                    <div class="price-box">
                                      ...
                                      <p class="old-price"> <span class="price-sep">-</span> <span class="price"> Rp. 50.000 </span> </p>
                                    </div>
                                  </div>
                                  <!--item-content--> 
                                </div>
                              ...
                              <div class="info">
                                <div class="info-inner">
                                  ...
                                  <div class="item-content">
                                    ...
                                    <div class="price-box"> <span class="regular-price"> <span class="price">Rp. 50.000</span> </span> </div>
                                  </div>
                                  <!--item-content--> 
                                </div>
                                <!--info-inner-->
