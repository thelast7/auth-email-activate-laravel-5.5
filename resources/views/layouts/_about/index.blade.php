...
<div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <ul>
          <li class="home"> <a title="Go to Home Page" href="{{ route('home') }}">Home</a><span>&mdash;›</span></li>
      ...
      <div class="row">
        <section class="col-main col-sm-14">
          ...
          <div class="static-contain">
            ...
            memiliki tingkat mobilitas tinggi, sehingga tidak memiliki cukup waktu untuk memenuhi kebutuhan mereka dalam mendapatkan bahan makanan yang segar dan berkualitas serta peralatan dapur yang mendukung. Sembapur memiliki latar belakang spirit hidup sehat dan berkualitas, karena kami tidak hanya menyediakan bahan pangan dan peralatannya, namun kami juga memberikan resep-resep yang anda butuhkan, cara memasak yang baik bahkan sampai dengan saran penyajian yang menarik. Sembapur menawarkan pengalaman yang berbeda dalam memenuhi kebutuhan dapur, kami memberikan kemudahan dalam berbelanja, kami memilihkan bahanbahan pangan yang terjamin kualitasnya dan kami juga akan menghantarkan kepada pembeli di hari yang sama.</b></p>
          </div><br>
